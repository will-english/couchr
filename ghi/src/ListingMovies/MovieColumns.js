              ...
              { (() => {
                if (props.default){
                  return (
                    ...
                    <i className="detail_icon_my-tip_list">
                      <svg xmlns="http://www.w3.org/2000/svg" width="50" height="25" fill="currentColor" id="list-icon" class="bi bi-clock-history detail_image_area_icon" viewBox="0 0 16 16">
