                  ...
                  <div className="card-body">
                    ...
                    {/* <div className="list-icons"> */}
                        <i className="detail_icon_my-tip_list">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="25" fill="currentColor" className="bi bi-star detail_image_area_icon" viewBox="0 0 16 16">
                        ...
                        <i className="detail_icon_my-tip_list">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="25" fill="currentColor" className="bi bi-clock detail_image_area_icon" viewBox="0 0 16 16">
